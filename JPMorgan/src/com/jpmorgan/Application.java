...
public class Application {
	...
	public static void main(String[] args) {
		...
		// it can be used from command o just as sample from the main method as
		// i do

		// Insert new Data

		Record rec = null;
		rec = rc.addNewRecord("foo", "B", 0.50f, "SGP", "01 Jan 2017", "08 Jan 2017", 200, 100.25);
		if (rec != null) {
			records.add(rec);
		}
		rec = rc.addNewRecord("foo", "B", 0.50f, "SGP", "08 Jul 2018", "09 Jul 2018", 200, 100.25);
		if (rec != null) {
			records.add(rec);
		}
		...
		// Ranking of entities based on incoming and outgoing amount. Eg: If
		// entity foo instructs the highest
